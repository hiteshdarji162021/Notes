...
|---|---|---|
| `textContent()` | Hidden + Visible | Reads full DOM text |
| `innerText()` | Only Visible | Skips hidden elements |

✅ **Hidden text IS included in `textContent()` output**  
❌ **Hidden text is NOT included in `innerText()` output**
...
---
|---|---|---|
| `textContent()` | ✅ YES | ❌ No | Reads raw DOM text |
| `innerText()` | ❌ NO | ✅ Yes | Reads only visible UI |
