# JavaScript Callbacks – Complete Reference Guide
...
## 1️⃣ What is a Callback? (Core Idea)
...
## 2️⃣ Example 1 – Passing Function as Argument
...
## 3️⃣ Example 2 – Inline Callback (Anonymous Function)
...
## 4️⃣ Example 3 – Callback Returning Value
...
## 5️⃣ Additional Advanced Callback Examples (Calculator & Design Patterns)
...
### 5.1 Strategy Pattern – Calculator Using Callbacks
...
## 6️⃣ Example 4 – Real‑World Async Callback (Coffee Machine)
...
## Not working like below its run async mode
...
- so call with below way

## ⚠️ Callback Hell (Problem) -Pyramid of doom.. worst way for writing code...
...
- Callback Hell is Hard to read, Hard to debug,Hard to scale

---

### Solution

- use Async and await solve Callback Hell problem
...
> 💡 **If callbacks are not clear, Promises will never be clear.**
